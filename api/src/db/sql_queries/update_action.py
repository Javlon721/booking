...
from src.db.sql_queries.utils import create_column_assignments, is_query_empty


def update_row(columns: list[str], conditions: list[str], table_name: str, *,
               placeholder_postfix: str = '') -> Composed:
    ...
    statement = SQL('update {table_name} set {values} {conditions} returning *')
