...
from src.db.sql_queries.utils import is_query_empty


def delete_row(conditions: list[str], table_name: str) -> Composed:
    ...
    return SQL('delete from {table_name} {conditions} returning *').format(table_name=Identifier(table_name),
